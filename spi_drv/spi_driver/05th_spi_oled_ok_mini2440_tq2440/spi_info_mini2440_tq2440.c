...
static struct spi_board_info spi_info_jz2440[] = {
	{
    	 ...
    	 .mode    = SPI_MODE_0,
    	 .chip_select   = S3C2410_GPG(1), /* oled_cs, 它的含义由spi_master确定 */
    	 .platform_data = (const void *)S3C2410_GPF(3) , /* oled_dc, 它在spi_driver里使用 */    	 
	 },
	 {
    	 ...
    	 .bus_num = 0,     /* jz2440里OLED接在SPI CONTROLLER 1 */
    	 .mode    = SPI_MODE_0,
    	 .chip_select   = S3C2410_GPG(10), /* flash_cs, 它的含义由spi_master确定 */
	 }
};
